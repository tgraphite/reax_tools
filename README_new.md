...
**访问地址**: http://cc-portal.xyz/reax_tools_pro
...
**推荐配置**: Chrome 浏览器，PC 端，轨迹大小 < 100,000 原子 × 1,000 帧
...
| `reactions_full.dot` | 完整反应网络 |
| `molecules/` | 分子结构图像（PNG） |
| `molecules.smi` | 分子 SMILES 列表 |
| `centered_on_*.dot` | 以特定分子为中心的反应子图 |
...
**推荐配置**: Linux, 8 核, 原子数×帧数 < 1,000,000,000
