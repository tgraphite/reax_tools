...
void ReaxSpecies::import_frame_formulas(const std::vector<std::string>& frame_formulas)
{
	all_frame_formulas.push_back(frame_formulas);
}

// Analyze imported frame formulas and get standard formulas_nums after ReaxSpeices::import_frame_formulas all done.
