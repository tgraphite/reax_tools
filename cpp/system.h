...
class System
{
  public:
    ...
    void set_rvdw_scale(float value)
    {
        rvdw_scale = value;
    }
    void set_max_neigh(int value)
    {
        max_neigh = value;
    }
    void set_reax_flow(ReaxFlow *value)
    {
        reax_flow = value;
    }
    void set_reax_species(ReaxSpecies *value)
    {
        reax_species = value;
    }
    void set_frame_id(int value)
    {
        frame_id = value;
    }
    void set_prev_sys(System *value)
    {
        prev_sys = value;
    }
    void set_reaxflow_threshold(float value)
    {
        reaxflow_threshold = value;
    }
